    ...
    if (attribute->primary == 0) {
      ...
      if (color == 8) {
        ...
        if (type == 5) { /* color from 256 color table */
          ...
          *target = (struct color){.c.table = color, .kind = COLOR_TABLE};
        } else if (type == 2) {
