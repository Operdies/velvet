...
static bool CHA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool SU(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool SD(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI ? 5 W Reset tab stops to start with column 9, every 8 columns (DECST8C), VT510. */
static bool DECST8C(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool CBT(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps `  Character Position Absolute  [column] (default = [row,1]) (HPA). */
static bool HPA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps a  Character Position Relative  [columns] (default = [row,col+1]) (HPR). */
static bool HPR(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool DA_TERTIARY(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI > Ps c Send Device Attributes (Secondary DA). */
static bool DA_SECONDARY(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool VPR(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool TBC(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool DECSET(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps i  Media Copy (MC). */
static bool MC(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI ? Ps i Media Copy (MC), DEC-specific. */
static bool DECMC(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pm l  Reset Mode (RM). */
static bool RM(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI ? Pm l DEC Private Mode Reset (DECRST). */
static bool DECRST(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool DSR(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI ? Ps n Device Status Report (DSR, DEC-specific). */
static bool DECDSR(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI ! p   Soft terminal reset (DECSTR), VT220 and up. */
static bool DECSTR(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pl ; Pc " p Set conformance level (DECSCL), VT220 and up. */
static bool DECSCL(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps $ p Request ANSI mode (DECRQM). */
/* CSI ? Ps $ p Request DEC private mode (DECRQM).   */
static bool DECRQM(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps q  Load LEDs (DECLL), VT100. */
static bool DECLL(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool DECSCA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool DECCARA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pl ; Pr s Set left and right margins (DECSLRM), VT420 and up.  This is available only when DECLRMM is enabled. */
static bool DECSLRM(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool DECSWBV(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pt ; Pl ; Pb ; Pr ; Pm $ t Reverse Attributes in Rectangular Area (DECRARA), VT400 and up. */
static bool DECRARA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI u     Restore cursor (SCORC, also ANSI.SYS). */
static bool SCORC(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI & u   User-Preferred Supplemental Set (DECRQUPSS), VT320, VT510. Response is DECAUPSS. */
static bool DECRQUPSS(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps SP u Set margin-bell volume (DECSMBV), VT520. */
static bool DECSMBV(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI " v   Request Displayed Extent (DECRQDE), VT340, VT420. */
static bool DECRQDE(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pt ; Pl ; Pb ; Pr ; Pp ; Pt ; Pl ; Pp $ v Copy Rectangular Area (DECCRA), VT400 and up. */
static bool DECCRA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps $ w Request presentation state report (DECRQPSR), VT320 and up. */
static bool DECRQPSR(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pt ; Pl ; Pb ; Pr ' w Enable Filter Rectangle (DECEFR), VT420 and up. */
static bool DECEFR(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/*   CSI Ps x  Request Terminal Parameters (DECREQTPARM). */
static bool DECREQTPARM(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps * x Select Attribute Change Extent (DECSACE), VT420 and up. */
static bool DECSACE(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pc ; Pt ; Pl ; Pb ; Pr $ x Fill Rectangular Area (DECFRA), VT420 and up. */
static bool DECFRA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pi ; Pg ; Pt ; Pl ; Pb ; Pr * y Request Checksum of Rectangular Area (DECRQCRA), VT420 and up. */
static bool DECRQCRA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps ; Pu ' z Enable Locator Reporting (DECELR). */
static bool DECELR(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pt ; Pl ; Pb ; Pr $ z Erase Rectangular Area (DECERA), VT400 and up. */
static bool DECERA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pm ' { Select Locator Events (DECSLE). */
static bool DECSLE(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Pt ; Pl ; Pb ; Pr $ { Selective Erase Rectangular Area (DECSERA), VT400 and up. */
static bool DECSERA(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps $ | Select columns per page (DECSCPP), VT340. */
static bool DECSCPP(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps ' | Request Locator Position (DECRQLP). */
static bool DECRQLP(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps * | Select number of lines per screen (DECSNLS), VT420 and up. */
static bool DECSNLS(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps ; Pf ; Pb , | Assign Color (DECAC), VT525 only. */
static bool DECAC(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
...
static bool DECATC(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps ' } Insert Ps Column(s) (default = 1) (DECIC), VT420 and up. */
static bool DECIC(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps $ } Select active status display (DECSASD), VT320 and up. */
static bool DECSASD(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps ' ~ Delete Ps Column(s) (default = 1) (DECDC), VT420 and up. */
static bool DECDC(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }

/* CSI Ps $ ~ Select status line type (DECSSDT), VT320 and up. */
static bool DECSSDT(struct fsm *fsm, struct csi *csi) { return csi_dispatch_todo(fsm, csi); }
