return function()
  ...
  assert(t.layout.children[1].name == 'panel_a',
    'children[1].name: expected "panel_a", got ' .. tostring(t.layout.children[1].name))
  assert(t.layout.children[1].width == 100,
    'children[1].width: expected 100, got ' .. tostring(t.layout.children[1].width))
  assert(t.layout.children[1].height == 200,
    'children[1].height: expected 200, got ' .. tostring(t.layout.children[1].height))
  assert(t.layout.children[1].visible == true,
    'children[1].visible: expected true, got ' .. tostring(t.layout.children[1].visible))
  assert(t.layout.children[2].name == 'panel_b',
    'children[2].name: expected "panel_b", got ' .. tostring(t.layout.children[2].name))
  assert(t.layout.children[2].width == 300,
    'children[2].width: expected 300, got ' .. tostring(t.layout.children[2].width))
  assert(t.layout.children[2].height == 400,
    'children[2].height: expected 400, got ' .. tostring(t.layout.children[2].height))
  assert(t.layout.children[2].visible == false,
    'children[2].visible: expected false, got ' .. tostring(t.layout.children[2].visible))
