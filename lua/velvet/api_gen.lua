...
write_file(out_dir .. "/velvet_autogen_helpers.c", table.concat(helpers))
...
--- @param when? velvet.async.single_when<velvet.api.%s> predicate function
