...
static void signal_callback(struct io_source *src, struct string_slice str) {
...
static void stdin_callback(struct io_source *src, struct string_slice str) {
...
static void read_callback(struct io_source *src, struct string_slice str) {
  struct app_context *m = src->data;
  struct vte_host *vte;
...
static void render_func(struct string_slice str, void *context) {
  int fd = *(int*)context;
